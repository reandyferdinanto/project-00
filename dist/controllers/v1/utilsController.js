    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            fs_1.default.createReadStream(filePath).pipe((0, csv_parser_1.default)())
                ...
                RowCount += 1;
                yield Student_1.default.create(row);
            }))
                ...
                const METRICSCHOOL = yield MetricSchool_1.default.findOne({ where: { school_id: req.body.school_id } });
                yield METRIC.update({ total_student: METRIC.total_student + RowCount });
                const isHas = yield METRIC.hasMetric_school(METRICSCHOOL);
                if (!isHas) {
                    ...
                    yield METRIC.addMetric_school(NEW_METRICSCHOOL);
                }
                else {
                    yield METRICSCHOOL.update({
...
function ExportCSV(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const Users = yield Student_1.default.findAll({ where: { school_id: req.body.school_id }, include: Exam_1.default });
        const Exams = yield Exam_1.default.findAll({ where: { school_id: req.body.school_id } });
        ...
        for (const [_, kelas] of registeredClass.entries()) {
            ...
            for (const [index, exam] of Exams.entries()) {
                ...
                for (const user of usersFilterKelas) {
                    let Exams = (yield user.getExams({ where: { unique_id: exam.unique_id } }))[0];
            ...
            try {
                yield workbook.xlsx.writeFile(`${filePath}/${req.body.school_name}-${kelas}.xlsx`);
...
function UpdateLoginStatus(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let student = yield Student_1.default.findByPk(id);
            let admin = yield Admin_1.default.findByPk(id);
            if (student) {
