...
const GetAllStudent = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (Object.keys(studentQuery).length !== 0) {
            let students = yield Student_1.default.findAll({ attributes: { exclude: ["createdAt", "updatedAt", "password"] }, include: [
...
const GetStudentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const student = yield Student_1.default.findByPk(studentId, { attributes: { exclude: ["createdAt", "updatedAt", "password"] }, include: [
                { model: Exam_1.default, attributes: { exclude: ["createdAt", "updatedAt"] }, },
            ] });
        if (student) {
...
const AddStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newStudents = yield Student_1.default.create(studentData);
        const METRIC = yield Metric_1.default.findOne();
        const METRICSCHOOL = yield MetricSchool_1.default.findOne({ where: { school_id: studentData.school_id } });
        METRIC.update({ total_student: METRIC.total_student + 1 });
        METRIC.hasMetric_school(METRICSCHOOL).then((isHas) => __awaiter(void 0, void 0, void 0, function* () {
            if (!isHas) {
...
const UpdateStudentPoint = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield StudentExam_1.default.findOne({ where: { score_id: id, exam_id: exam_id }, })
            .then((prev) => {
            if (prev.point) {
...
const DeleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield Student_1.default.destroy({
            where: {
...
const EditStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let studentData = req.body;
        // User update
        const user = yield Student_1.default.findByPk(studentId);
        if (!user)
            return (0, response_1.default)(400, "user not found", [], res);
        ...
        exams_on.forEach((exam_id) => __awaiter(void 0, void 0, void 0, function* () {
            let exam = yield Exam_1.default.findByPk(exam_id);
            if (!(yield exam.hasStudent(user))) {
                yield exam.addStudent(user);
            }
        }));
        exams_off.forEach((exam_id) => __awaiter(void 0, void 0, void 0, function* () {
            let exam = yield Exam_1.default.findByPk(exam_id);
            if (yield exam.hasStudent(user)) {
...
const AuthStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let nis = req.body.nis ? req.body.nis : "";
    let password = req.body.password ? req.body.password : "";
    let token = req.body.token ? req.body.token : null;
    try {
        let data;
        let studentLogin = yield Student_1.default.findOne({ where: { nis }, raw: true, attributes: { exclude: ["createdAt", "updatedAt"] } });
        let adminLogin = yield Admin_1.default.findOne({ where: { nuptk: nis }, raw: true, attributes: { exclude: ["createdAt", "updatedAt"] } });
        ...
        if (adminLogin) {
            let passwordCorrect = yield bcrypt_1.default.compare(password, adminLogin.password);
            if (passwordCorrect) {
        ...
        if (data !== undefined) {
            const METRIC = yield Metric_1.default.findOne();
            const METRICSCHOOL = yield MetricSchool_1.default.findOne({ where: { school_id: data.school_id } });
